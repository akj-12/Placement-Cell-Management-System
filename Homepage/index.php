...
<head>
    ...
    <!-- icon -->
    <link rel="shortcut icon" type="image/x-png" href="./gallery/ipuIcon.png" />
    <!-- main css style  -->
...
<body>
    ...
    <nav class="navbar navbar-expand-md bg-color navbar-dark">
        <!-- Brand -->
        <a class="navbar-brand" href="http://www.ipu.ac.in"><img src="./gallery/ipulogo.png" alt="ipu logo" height="80vh" width="auto"></a>
